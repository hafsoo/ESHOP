...
const DashboardSideBar = ({ active }) => {
  return (
    <div className="w-full h-[100vh] bg-white shadow-sm overflow-y-auto sticky top-0 left-0 z-10">

      {/* Dashboard */}
      <div className="w-full flex items-center p-4 800px:p-3">
      ...
      <div className="w-full flex items-center p-4 800px:p-3">
        <Link to="/dashboard-events" className="w-full flex items-center">
          <MdEvent size={30} color={active === 5 ? "crimson" : "#555"} />
